...
function ITEM:OnSendData()
	...
	if (index) then
		...
		if (inventory) then
			inventory.vars.isLLC = self.uniqueID
...
function ITEM:CanTransfer(oldInventory, newInventory)
	...
	return !newInventory or newInventory:GetID() != oldInventory:GetID() or newInventory.vars.isLLC
end
