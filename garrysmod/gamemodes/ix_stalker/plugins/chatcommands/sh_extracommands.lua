...
PLUGIN.author = "Luna + Verne"
PLUGIN.desc = "A few useful commands."

-- Below 2 come from a similarly named file attributed to Verne. I have no idea who authored what here.
...
hook.Add("PopulateScoreboardPlayerMenu", "ixAdmin", function(client, menu)
	...
	--[[ Do not work, the commands these call straight up do not exist
	options["Set Health"] = {
