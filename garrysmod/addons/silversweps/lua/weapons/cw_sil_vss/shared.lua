...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["std_mag"] = {model = "models/silver/stalker/weapons/attachments/a_vss_10.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cw_sil_vss_20"] = {model = "models/silver/stalker/weapons/attachments/a_vss_20.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["std_mag"] = {model = "models/silver/stalker/weapons/attachments/w_vss_10.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cw_sil_vss_20"] = {model = "models/silver/stalker/weapons/attachments/w_vss_20.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_vss.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_vss.mdl"
...
if CLIENT then
	function SWEP:updateStandardParts()
		self:setElementActive("std_mag", !self.ActiveAttachments.cw_sil_vss_20)
	end
end