...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/a_foregrip_sec.mdl", pos = Vector(0,0,0.3), angle = Angle(0,90,0), size = Vector(0.5, 0.5, 0.5), attachment = "Foregrip"},
		...
		["cw_sil_okp7_optic"] = {model = "models/silver/stalker/weapons/attachments/a_okp7_optic.mdl", bone = "A_Optic", pos = Vector(0, -0.4, -0.5), angle = Angle(90, 90, 0), size = Vector(1.3, 1.3, 1.3), merge = false},
		["cw_sil_ekp_optic"] = {model = "models/silver/stalker/weapons/attachments/a_ekp_optic.mdl", bone = "A_Optic", rLight = true, pos = Vector(0, 0.4, 0), angle = Angle(90, 90, 0), size = Vector(1.3, 1.3, 1.3), merge = false},
		...
		["cw_sil_ip29_scope"] = {model = "models/silver/stalker/weapons/attachments/a_ip29_scope.mdl", bone = "A_Optic", pos = Vector(0, 0, -2.75), angle = Angle(90, 90, 0 ), size = Vector(1, 1, 1), merge = false},
	}
	...
	SWEP.IronsightPos = Vector(-2.32, -2, 0.662)
	...
	SWEP.CWSILOKP7Pos = Vector(-2.3111, 2, -0.3139)
	SWEP.CWSILOKP7Ang = Vector()

	SWEP.CWSILEKPPos = Vector(-2.3114, 3, -0.9725)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_aek973.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_aek973.mdl"
