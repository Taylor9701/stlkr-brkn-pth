...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,0,8.25), angle = Angle(0,180,180), size = Vector(1, 1, 1), merge = true},
...
SWEP.Animations = {
	...
	foregrip_fire_empty_aim = "foregrip_iron_dryfire", // like srsly?
...
SWEP.ViewModel		= "models/weapons/aek971/v_aek971.mdl"
SWEP.WorldModel		= "models/weapons/aek971/w_aek971.mdl"
