...
if CLIENT then
	...
	SWEP.PrintName = "Steyr AUG A3 Para"
	...
	SWEP.IronsightPos = Vector(-2.69, -2, 0.9)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_augp.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_augp.mdl"
...
SWEP.FireSound = "CW_SIL_MP5A4_FIRE"
